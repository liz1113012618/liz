...
var SweepDetail = React.createClass({
onPress: function () {
...
async processDataSubmit(){
     this.setState({visible:true});
      ...
      var userId = await AsyncStorage.getItem(DataKEY.USER_ID);  
       var  order_id=this.props.message.order_id;
       var  dc_order=this.props.message.dc_order;
