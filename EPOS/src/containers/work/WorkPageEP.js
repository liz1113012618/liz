...
var WorkPageEP = React.createClass({

  getInitialState: function() {
    var ds = new ListView.DataSource({rowHasChanged: (r1, r2) => r1 !== r2});
    return {
		dataSource: ds.cloneWithRows(this._genRows({})),
		btnTitles : ['图书馆','问卷调查','会员建议','产品到货','扫码出货','今日开单','门店积分','样品到货','报表管理'],
		btnColor : ['#58D6AE','#D68DEE','#F4799E','#E1C072','#849DDD','#58D6AE','#F4799E','#E1C072','#D68DEE'],
		btnIcon : ['folder','book','users','bus','shopping-cart','credit-card','money','truck','credit-card'],
		selected:  null ,
		headTitle:'工作',
    };
  },
  ...
  _renderRow: function(rowData: string, sectionID: number, rowID: number) {
   ...
   _genRows: function(pressData: {[key: number]: boolean}): Array {
	    var btnTitles = ['图书馆','问卷调查','会员建议','产品到货','扫码出货','今日开单','门店积分','样品到货','报表管理'];
		var dataBlob = []; 
