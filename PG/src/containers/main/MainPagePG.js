...
import HomePagePG from '../home/HomePagePG';
import MessagePage from '../message/MessagePage';
import WorkPage from '../work/WorkPagePG';
import SettingsPage from '../settings/SettingsPage';
import StoreListPage from '../store/StoreListPage';


var MainPagePG = React.createClass({

	componentWillMount() {
		AsyncStorage.getItem('USER_ROLE_ID').then((value) => { 
	 ...
	 render: function() {
	 	var homePage = <HomePagePG navigator={this.props.navigator} />;
        return (
            <TabNavigator>
